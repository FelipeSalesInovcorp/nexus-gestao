...
const form = useForm({
    ...
    supplier_order_id: '' as string | number,
    number: '',
    issue_date: '',
    due_date: '',
    total: '',
...
const filteredOrders = computed(() => {
    // por agora o backend manda vazio no create()
    // quando você implementar carregamento por fornecedor, isso fica automático.
    return props.supplierOrders ?? [];
});

function submit() {
    form.post('/finance/supplier-invoices', {
        forceFormData: true,
        preserveScroll: true,
    });
}
...
<template>
    <div class="max-w-3xl space-y-6 p-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold">Criar fatura fornecedor</h1>
