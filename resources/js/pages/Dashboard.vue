    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <div class="grid gap-4 md:grid-cols-3">
                ...
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between"
                    >
                        <CardTitle class="text-base">Encomendas</CardTitle>
                        <Badge variant="secondary">MVP</Badge>
                    </CardHeader>
                    <CardContent class="space-y-1">
                        <div class="text-3xl font-semibold">—</div>
                        <div class="text-sm text-muted-foreground">
                            Criar/editar + PDF + conversão
                        </div>
                    </CardContent>
                </Card>
                ...
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between"
                    >
                        <CardTitle class="text-base">Artigos</CardTitle>
                        <Badge variant="secondary">catálogo</Badge>
                    </CardHeader>
                    <CardContent class="space-y-1">
                        <div class="text-3xl font-semibold">—</div>
                        <div class="text-sm text-muted-foreground">
                            Referência, preço e taxa de IVA
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <div class="grid gap-4 lg:grid-cols-3">
                <!-- Atalhos -->
                <Card
                    class="border-sidebar-border/70 bg-slate-900/40 lg:col-span-2 dark:border-sidebar-border"
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between"
                    >
                        <CardTitle>Atalhos rápidos</CardTitle>
                        <span class="text-sm text-muted-foreground">ações</span>
                    </CardHeader>
                    ...
                    <CardContent class="space-y-3">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <Link href="/config/products/create">
                                <Button variant="outline">Novo artigo</Button>
                            </Link>

                            <Link href="/entities/create">
                                <Button variant="outline">Nova entidade</Button>
                            </Link>
                        </div>

                        <div class="text-sm text-muted-foreground">
                            Fluxo recomendado para demonstração:
                            <b>Proposta → PDF → Converter → Encomenda → PDF</b>.
                        </div>
                    </CardContent>
                </Card>
                ...
                >
                    ...
                    <CardContent class="space-y-2 text-sm">
                        <div class="flex items-center justify-between">
                            <span>Entidades</span>
                            <Link href="/entities" class="underline"
                                >Abrir</Link
                            >
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <span>Artigos</span>
                            <Link href="/config/products" class="underline"
                                >Abrir</Link
                            >
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <span>Propostas</span>
                            <Link href="/proposals" class="underline"
                                >Abrir</Link
                            >
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <Link href="/orders" class="underline">Abrir</Link>
                        </div>

                        <div class="flex items-center justify-between">
                            <span>Contactos</span>
                            <Link href="/contacts" class="underline"
                                >Abrir</Link
                            >
                        </div>
                    </CardContent>
