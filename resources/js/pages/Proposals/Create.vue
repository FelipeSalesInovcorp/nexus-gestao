...
const validDefault = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().slice(0, 10)
                ...
                <form class="space-y-4" @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p v-if="form.errors.proposal_date" class="text-sm text-red-600">{{
                                form.errors.proposal_date }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <p v-if="form.errors.valid_until" class="text-sm text-red-600">{{ form.errors.valid_until }}
                            </p>
                        </div>
